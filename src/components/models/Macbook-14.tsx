/*
Auto-generated by gltfjsx (правки для TS)
*/
...
// ОПИС ТИПІВ, які дав gltfjsx (залишаю як у тебе)
type GLTFResult = GLTF & {
    ...
    animations: THREE.AnimationClip[]; // ← було GLTFAction[]
};

export default function MacbookModel14(props: ThreeElements['group']) {
    // ВАЖЛИВО: правильний шлях до файлу в public/
